            ...
            if($_SERVER['REQUEST_METHOD'] == 'POST'){
              try {
                ...
                $q ->execute(array($_POST['SId'],$_POST['M_Name'],$_POST['FBname'],$_POST['LineID'],$_POST['Email'],$_POST['Phone'],$_POST['Degree'],$_POST['Sex'],$_POST['B_date'],$_POST['passwords'],$_POST['Grade'],$_POST['Enter_date'],$_POST['Being'],$_POST['Dno']));
                  print "已完成新增社員 ".$_POST['M_Name'];
                  print "即將返回新增社員畫面！";
                  ?>
              <script type="text/javascript"> setTimeout("window.location.href='add_Member.php'",3000); </script>
             <?php }
...
<form action="<?php $_SERVER['PHP_SELF']?>" method = "post" >
  <div class="form-row">
    <div class="form-group col-md-6">
      <label>學號</label>
      <input type="text" class="form-control" id="inputEmail4" name ="SId"placeholder="學號" required>
    </div>
    <div class="form-group col-md-6">
      <label for="inputPassword4">預設密碼</label>
      <input type="password" class="form-control" id="inputPassword4" name ="passwords"placeholder="Password" required>
    </div>
  </div>
  <div class="form-row">
    <div class="form-group col-md-6">
      <label for="inputName">姓名</label>
      <input type="text" class="form-control" id="inputName" name ="M_Name" placeholder="王小明" required>
    </div>
    <div class="form-group col-md-6">
    <label for="inputBDate">生日</label>
    <input type="date" class="form-control" name ="B_date"id="inputBDate" required >
    </div>
  </div>
  <div class="form-row">
    <div class="form-group col-md-6">
        ...
        <select id="inputDepartment" class="form-control" name ="Dno" required>
          <option selected value = "">選擇科系</option>
          <?php
          for($i=0;$i<$rows_count;$i++){
            print "<option value=".$rows[$i][0].">".$rows[$i][0]." ".$rows[$i][1]."</option>";
          }
          ?>
        </select>
    </div>
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="inputFBName"name ="FBname" placeholder="FB name">
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="inputPhone" name ="Phone"placeholder="手機號碼" required>
  </div>
  <div class="form-row">
    ...
    <input type="date" class="form-control" id="inputDate" name ="Enter_date" required>
    </div>
  </div>
   <div class="form-group">
   <button class="btn btn-primary" type="submit">新增社員資料</button>
