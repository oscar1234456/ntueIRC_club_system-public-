        ...
        <div class="title">修改我的資料</div>      
            ...
            <?php
              ...
              try {
                ...
                $q = $conn ->query("select * from Member where SId =".$_SESSION['userId'].";");
                $rows = $q->fetchAll();
...
<form action="update_Member_mem2.php" method = "post" >
  <div class="form-row">
  ...
  <div class="form-row">
    ...
    <div class="form-group col-md-4">
      ...
      <select id="inputStatus" class="form-control" name ="Being" required disabled>
    ...
    <input type="date" class="form-control" id="inputDate" value="<?php print $rows[0][11];?>"name ="Enter_date" required disabled>
