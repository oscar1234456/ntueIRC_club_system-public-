...
<html lang="en">
  ...
  <script language="javascript">
   function doubleCheck(){
      var sure = window.confirm('確定要刪除此課程？');
      if (!sure) return;
  ...
  <body>
    ...
    <?php
      try {
        ...
        $q2 = $conn ->query("select CId,Course_name from Course;");
        $rows2 = $q2->fetchAll();
...
<div id="sidebar">
    <div id="content">
        <div class="title">刪除課程</div>      
            <div class="learn">
            <br>
            <h4>請選擇您要<strong><mark>刪除</mark></strong>的課程:</h4>
