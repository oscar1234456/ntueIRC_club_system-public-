    ...
    <?php
      try {
        ...
        if($_SESSION['Carde'] == "社長"){
          $q = $conn ->query("select CId,Course_name from Course");
        }else{
          $q = $conn ->query("select CId,Course_name from Course where TeacherId = '".$_SESSION['userId']."'");
        }
        $rows = $q->fetchAll();
...
<div id="sidebar">
    <div id="content">
        <div class="title">修改課程</div>      
            <div class="learn">
            <h4>請選擇您要修改的課程:</h4>
            <form action="course_update_keep.php" method="post">
              <div class="form-row">
