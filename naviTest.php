...
<html lang="en">
  ...
  <body>
    ...
    <div id="header"></div>
      <div class="jumbotron">
        <h1 class="display-4">ntueIRC社團系統</h1>  <br>
        <p class="lead">歡迎使用本系統！</p>  
        <hr class="my-4">  
        <p> </p>  
        <p class="lead"><a class="btn btn-primary btn-lg" href="#1" role="button">帶我看看推薦好文！</a></p>
      </div>
