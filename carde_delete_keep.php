    ...
    <div id="content">
        <div class="title">修改社員</div>      
            ...
            if($_SERVER['REQUEST_METHOD'] != 'POST'){
              print "請先指定您的幹部資訊！";
              print "<br>即將為您轉至刪除幹部頁面！";?>
              <script type="text/javascript"> setTimeout("window.location.href='carde_delete_keep.php'",3000); </script>
            <?php 
            }else{
              ...
              try {
                ...
                $q = $conn ->exec("delete from Carde where Carde_Name = "."'".$_POST['choose_Carde']."';");
                print "<strong>已成功解除".$_POST['choose_Carde']."的幹部資料</strong>";
