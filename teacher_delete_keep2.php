    ...
    <div id="content">
        <div class="title">刪除教師資料</div>      
            ...
            if($_SERVER['REQUEST_METHOD'] != 'POST'){
              print "請先查詢您要的教師！";
              print "<br>即將為您轉至<strong>刪除</strong>教師資料頁面！";?>
              <script type="text/javascript"> setTimeout("window.location.href='teacher_delete.php'",3000); </script>
            <?php 
            }else{
              ...
              try {
                ...
                $q = $conn ->exec("delete from Teacher where Teach_Id = ".$_POST['choose_Member'].";");
                print "<strong>已成功刪除".$_POST['choose_Member']." ".""."的資料</strong>";
                print "<br>即將返回至 刪除資料 頁面";
