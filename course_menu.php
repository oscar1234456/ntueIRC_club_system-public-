...
<html lang="en">
  ...
  <script>
    function click_update_mem(){
        window.location.href = "course_update.php";
    }
    ...
    function click_delete_mem(){
        window.location.href = "course_delete.php";
    }
...
<div id="sidebar">
    <div id="content">
          <div class="title">課程管理選單</div>      
          <div class="learn">
          <br>
            <button class="btn btn-primary" type="button" onclick='click_add_mem()'>新增課程資料</button>
            <br>
            <br>
            <button class="btn btn-primary" type="button" onclick='click_update_mem()'>修改課程資料</button>
            <br>
            <br>
            <?php 
            if($_SESSION['Carde']=="社長"){
              print("<button class='btn btn-primary' type='button' onclick='click_delete_mem()'>刪除課程資料</button> <br>");
            }
