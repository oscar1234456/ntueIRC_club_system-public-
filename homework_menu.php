...
<html lang="en">
  ...
  <script>
    function click_add_hw(){
        window.location.href = "homework_add.php";
    }
    
    function click_correct_hw(){
        window.location.href = "homework_correct.php";
    }

    function click_delete_mem(){
        window.location.href = "teacher_delete.php";
    }
...
<div id="sidebar">
    <div id="content">
          <div class="title">作業管理選單</div>      
          <div class="learn">
          <br>
            <button class="btn btn-primary" type="button" onclick='click_correct_hw()'>批改作業</button>
            <br>
            <br>
            <button class="btn btn-primary" type="button" onclick='click_add_hw()'>新增作業</button>
            <br>
            <br>
          <!--  <button class="btn btn-primary" type="button" onclick='click_delete_mem()'>修改作業</button>-->
            <br>
            <br>
            </div>
        </div>
