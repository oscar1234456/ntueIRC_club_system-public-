...
<html lang="en">
  ...
  <script>
    function double_check(){
        var sure = window.confirm("您確定要解除該名幹部資格嗎？");
        if(!sure){
          return;
        }else{
          del_carde_form.submit();
        }
...
<div id="sidebar">
    <div id="content">
        <div class="title">解除幹部資料</div>      
            <div class="learn">
            
            <form action="carde_delete_keep.php" method="post" name = "del_carde_form">
            <h4>請選擇您要解除的幹部:</h4>
              <div class="form-row">
              ...
              <div class="form-row">
                <div class="form-group col-md-4">
                    <button class="btn btn-primary" type="button" onclick="double_check()">解除</button>
                  </div>
              </div>
            </form>      
            </div>
