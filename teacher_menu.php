...
<html lang="en">
  ...
  <script>
    function click_update_mem(){
        window.location.href = "teacher_update.php";
    }
    
    function click_add_mem(){
        window.location.href = "teacher_add.php";
    }
...
<div id="sidebar">
    <div id="content">
          <div class="title">教師管理選單</div>      
          <div class="learn">
          <br>
            <button class="btn btn-primary" type="button" onclick='click_add_mem()'>新增教師資料</button>
            <br>
            <br>
            <button class="btn btn-primary" type="button" onclick='click_update_mem()'>修改教師資料</button>
            <br>
            <br>
            <button class="btn btn-primary" type="button" onclick='click_delete_mem()'>刪除教師資料</button>
            <br>
            <br>
            </div>
        </div>
